...
individual a cada persona inscripta y activa aproximadamente 24 horas y una
hora antes de la charla. Ambos correos vuelven a incluir la fecha y el enlace
privado de Zoom.
...
El valor predeterminado es `--anticipacion un-dia`. Para el segundo
recordatorio:

```bash
flask --app run:app enviar-recordatorios --anticipacion una-hora
```
